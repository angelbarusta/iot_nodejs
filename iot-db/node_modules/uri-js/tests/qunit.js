...
(function (window) {
  var QUnit = {
    ...
    test: function (testName, expected, callback, async) {
      var name = testName; var testEnvironment; var testEnvironmentArg
      ...
      synchronize(function () {
        ...
        if (tests) {
          ...
          addEvent(b, 'click', function () {
            var next = b.nextSibling; var display = next.style.display
          ...
          addEvent(b, 'dblclick', function (e) {
            ...
            if (target.nodeName.toLowerCase() === 'strong') {
              var text = ''; var node = target.firstChild
    ...
    var callbacks = (function () {
      ...
      return {
        ...
        'object': function (b, a) {
          ...
          var aProperties = []; var bProperties = [] // collection of strings
 ...
 */
  QUnit.jsDump = (function () {
    ...
    function array (arr) {
      var i = arr.length; var	ret = Array(i)
      this.up()
