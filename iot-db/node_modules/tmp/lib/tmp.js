...
const DIR_MODE = 448 /* 0o700 */

const FILE_MODE = 384 /* 0o600 */
...
function tmpName (options, callback) {
  ...
  var tries = opts.name ? 1 : opts.tries || DEFAULT_TRIES
...
function _rmdirRecursiveSync (root) {
  ...
  do {
    ...
    for (var i = 0, length = files.length; i < length; i++) {
      ...
      var stat = fs.lstatSync(file) // lstat so we don't recurse into symlinked directories
