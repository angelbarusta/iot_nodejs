(function (global, factory) {
  ...
  pp$1.parseFunction = function (node, statement, allowExpressionBody, isAsync) {
    ...
    if (statement & FUNC_STATEMENT) {
      ...
      if (node.id && !(statement & FUNC_HANGING_STATEMENT)) { this.checkLVal(node.id, this.inModule && !this.inFunction ? BIND_LEXICAL : BIND_FUNCTION) }
    }

    var oldYieldPos = this.yieldPos; var oldAwaitPos = this.awaitPos
    this.yieldPos = 0
    this.awaitPos = 0
  ...
  pp$3.parseMaybeAssign = function (noIn, refDestructuringErrors, afterLeftParse) {
    ...
    var ownDestructuringErrors = false; var oldParenAssign = -1; var oldTrailingComma = -1; var oldShorthandAssign = -1
  ...
  pp$3.parseSubscripts = function (base, startPos, startLoc, noCalls) {
    ...
    for (var computed = (void 0); ;) {
      if ((computed = this$1.eat(types.bracketL)) || this$1.eat(types.dot)) {
        ...
        var refDestructuringErrors = new DestructuringErrors(); var oldYieldPos = this$1.yieldPos; var oldAwaitPos = this$1.awaitPos
        this$1.yieldPos = 0
        this$1.awaitPos = 0
  ...
  pp$3.parseMethod = function (isGenerator, isAsync, allowDirectSuper) {
    var node = this.startNode(); var oldYieldPos = this.yieldPos; var oldAwaitPos = this.awaitPos
 ...
 */
  ...
  pp$8.readInt = function (radix, len) {
    ...
    for (var i = 0, e = len == null ? Infinity : len; i < e; ++i) {
      var code = this$1.input.charCodeAt(this$1.pos); var val = (void 0)
