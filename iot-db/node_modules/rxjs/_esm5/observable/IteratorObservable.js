...
export var IteratorObservable = /* @__PURE__ */ (/* @__PURE__ */ function (_super) {
  ...
  IteratorObservable.dispatch = function (state) {
    var index = state.index; var hasError = state.hasError; var iterator = state.iterator; var subscriber = state.subscriber
    if (hasError) {
  ...
  /** @deprecated internal use only */ IteratorObservable.prototype._subscribe = function (subscriber) {
    var index = 0
    var _a = this; var iterator = _a.iterator; var scheduler = _a.scheduler
    if (scheduler) {
