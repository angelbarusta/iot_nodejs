 ...
 */
  var Subscription = (function () {
    ...
    Subscription.prototype.unsubscribe = function () {
      ...
      var _a = this; var _parent = _a._parent; var _parents = _a._parents; var _unsubscribe = _a._unsubscribe; var _subscriptions = _a._subscriptions
      this.closed = true
      this._parent = null
      this._parents = null
    ...
    Subscription.prototype._addParent = function (parent) {
      var _a = this; var _parent = _a._parent; var _parents = _a._parents
 ...
 */
  var BoundCallbackObservable = (function (_super) {
      ...
      if (!scheduler) {
        if (!subject) {
          ...
          var handler = function handlerFn () {
            ...
            var selector = source.selector; var subject = source.subject
            if (selector) {
    ...
    BoundCallbackObservable.dispatch = function (state) {
      var self = this
      var source = state.source; var subscriber = state.subscriber; var context = state.context
      var callbackFunc = source.callbackFunc; var args = source.args; var scheduler = source.scheduler
  ...
  function dispatchNext (arg) {
    var value = arg.value; var subject = arg.subject
    subject.next(value)
    subject.complete()
  }
  function dispatchError (arg) {
    var err = arg.err; var subject = arg.subject
    subject.error(err)
  }
 ...
 */
  ...
  function dispatch (state) {
    ...
    var _a = source; var callbackFunc = _a.callbackFunc; var args = _a.args; var scheduler = _a.scheduler
    var subject = source.subject
    if (!subject) {
      subject = source.subject = new AsyncSubject()
      var handler = function handlerFn () {
 ...
 */
  var ScalarObservable = (function (_super) {
    ...
    ScalarObservable.dispatch = function (state) {
      var done = state.done; var value = state.value; var subscriber = state.subscriber
      if (done) {
        subscriber.complete()
        return
      }
 ...
 */
  var ArrayObservable = (function (_super) {
    ...
    ArrayObservable.dispatch = function (state) {
      var array = state.array; var index = state.index; var count = state.count; var subscriber = state.subscriber
      if (index >= count) {
        subscriber.complete()
        return
      }
 ...
 */
  ...
  function dispatchNext$2 (arg) {
    var value = arg.value; var subscriber = arg.subscriber
    if (!subscriber.closed) {
      subscriber.next(value)
      subscriber.complete()
    }
  ...
  function dispatchError$2 (arg) {
    var err = arg.err; var subscriber = arg.subscriber
    if (!subscriber.closed) {
      subscriber.error(err)
    }
  }
 ...
 */
  var IteratorObservable = (function (_super) {
    ...
    IteratorObservable.dispatch = function (state) {
      var index = state.index; var hasError = state.hasError; var iterator$$1 = state.iterator; var subscriber = state.subscriber
      if (hasError) {
    ...
    /** @deprecated internal use only */ IteratorObservable.prototype._subscribe = function (subscriber) {
      var index = 0
      var _a = this; var iterator$$1 = _a.iterator; var scheduler = _a.scheduler
      if (scheduler) {
 ...
 */
  var ArrayLikeObservable = (function (_super) {
    ...
    ArrayLikeObservable.dispatch = function (state) {
      var arrayLike = state.arrayLike; var index = state.index; var length = state.length; var subscriber = state.subscriber
      if (subscriber.closed) {
        return
      }
      if (index >= length) {
    ...
    /** @deprecated internal use only */ ArrayLikeObservable.prototype._subscribe = function (subscriber) {
      var index = 0
      var _a = this; var arrayLike = _a.arrayLike; var scheduler = _a.scheduler
      var length = arrayLike.length
      if (scheduler) {
 ...
 */
  var ObserveOnSubscriber = (function (_super) {
    ...
    ObserveOnSubscriber.dispatch = function (arg) {
      var notification = arg.notification; var destination = arg.destination
 ...
 */
  var ForkJoinSubscriber = (function (_super) {
    ...
    ForkJoinSubscriber.prototype.notifyComplete = function (innerSub) {
      var destination = this.destination
      var _a = this; var haveValues = _a.haveValues; var resultSelector = _a.resultSelector; var values = _a.values
 ...
 */
  var GenerateObservable = (function (_super) {
    ...
    /** @deprecated internal use only */ GenerateObservable.prototype._subscribe = function (subscriber) {
      ...
      var _a = this; var condition = _a.condition; var resultSelector = _a.resultSelector; var iterate = _a.iterate
      do {
        if (condition) {
    ...
    GenerateObservable.dispatch = function (state) {
      var subscriber = state.subscriber; var condition = state.condition
      if (subscriber.closed) {
        return
      }
 ...
 */
  var IfObservable = (function (_super) {
    ...
    /** @deprecated internal use only */ IfObservable.prototype._subscribe = function (subscriber) {
      var _a = this; var condition = _a.condition; var thenSource = _a.thenSource; var elseSource = _a.elseSource
 ...
 */
  var IntervalObservable = (function (_super) {
    ...
    IntervalObservable.dispatch = function (state) {
      var index = state.index; var subscriber = state.subscriber; var period = state.period
 ...
 */
  ...
  function dispatch$1 (state) {
    var obj = state.obj; var keys = state.keys; var length = state.length; var index = state.index; var subscriber = state.subscriber
    if (index === length) {
      subscriber.complete()
      return
    }
 ...
 */
  var PairsObservable = (function (_super) {
    ...
    /** @deprecated internal use only */ PairsObservable.prototype._subscribe = function (subscriber) {
      var _a = this; var keys = _a.keys; var scheduler = _a.scheduler
 ...
 */
  var RangeObservable = (function (_super) {
    ...
    RangeObservable.dispatch = function (state) {
      var start = state.start; var index = state.index; var count = state.count; var subscriber = state.subscriber
      if (index >= count) {
        subscriber.complete()
        return
      }
 ...
 */
  var UsingObservable = (function (_super) {
    ...
    /** @deprecated internal use only */ UsingObservable.prototype._subscribe = function (subscriber) {
      var _a = this; var resourceFactory = _a.resourceFactory; var observableFactory = _a.observableFactory
      var resource
      try {
 ...
 */
  var ErrorObservable = (function (_super) {
    ...
    ErrorObservable.dispatch = function (arg) {
      var error = arg.error; var subscriber = arg.subscriber
 ...
 */
  var TimerObservable = (function (_super) {
    ...
    TimerObservable.dispatch = function (state) {
      var index = state.index; var period = state.period; var subscriber = state.subscriber
      var action = this
      subscriber.next(index)
      if (subscriber.closed) {
        return
    ...
    /** @deprecated internal use only */ TimerObservable.prototype._subscribe = function (subscriber) {
      var index = 0
      var _a = this; var period = _a.period; var dueTime = _a.dueTime; var scheduler = _a.scheduler
 ...
 */
  var AjaxSubscriber = (function (_super) {
    ...
    AjaxSubscriber.prototype.next = function (e) {
      this.done = true
      var _a = this; var xhr = _a.xhr; var request = _a.request; var destination = _a.destination
      var response = new AjaxResponse(e, xhr, request)
      destination.next(response)
    }
    AjaxSubscriber.prototype.send = function () {
      var _a = this; var request = _a.request; var _b = _a.request; var user = _b.user; var method = _b.method; var url = _b.url; var async = _b.async; var password = _b.password; var headers = _b.headers; var body = _b.body
    ...
    AjaxSubscriber.prototype.setupEvents = function (xhr, request) {
      ...
      function xhrTimeout (e) {
        var _a = xhrTimeout; var subscriber = _a.subscriber; var progressSubscriber = _a.progressSubscriber; var request = _a.request
      ...
      if (xhr.upload && 'withCredentials' in xhr) {
        ...
        xhrError_1 = function (e) {
          var _a = xhrError_1; var progressSubscriber = _a.progressSubscriber; var subscriber = _a.subscriber; var request = _a.request
          if (progressSubscriber) {
            progressSubscriber.error(e)
          }
      ...
      function xhrReadyStateChange (e) {
        var _a = xhrReadyStateChange; var subscriber = _a.subscriber; var progressSubscriber = _a.progressSubscriber; var request = _a.request
    ...
    AjaxSubscriber.prototype.unsubscribe = function () {
      var _a = this; var done = _a.done; var xhr = _a.xhr
 ...
 */
  var WebSocketSubject = (function (_super) {
    ...
    WebSocketSubject.prototype.unsubscribe = function () {
      var _a = this; var source = _a.source; var socket = _a.socket
      if (socket && socket.readyState === 1) {
        socket.close()
        this._resetState()
      }
 ...
 */
  var BufferSkipCountSubscriber = (function (_super) {
    ...
    BufferSkipCountSubscriber.prototype._next = function (value) {
      var _a = this; var bufferSize = _a.bufferSize; var startBufferEvery = _a.startBufferEvery; var buffers = _a.buffers; var count = _a.count
      this.count++
    ...
    BufferSkipCountSubscriber.prototype._complete = function () {
      var _a = this; var buffers = _a.buffers; var destination = _a.destination
 ...
 */
  var BufferTimeSubscriber = (function (_super) {
    ...
    BufferTimeSubscriber.prototype._complete = function () {
      var _a = this; var contexts = _a.contexts; var destination = _a.destination
  ...
  function dispatchBufferCreation (state) {
    var bufferCreationInterval = state.bufferCreationInterval; var bufferTimeSpan = state.bufferTimeSpan; var subscriber = state.subscriber; var scheduler = state.scheduler
  ...
  function dispatchBufferClose (arg) {
    var subscriber = arg.subscriber; var context = arg.context
 ...
 */
  var SwitchFirstMapSubscriber = (function (_super) {
    ...
    SwitchFirstMapSubscriber.prototype.notifyNext = function (outerValue, innerValue, outerIndex, innerIndex, innerSub) {
      var _a = this; var resultSelector = _a.resultSelector; var destination = _a.destination
      if (resultSelector) {
 ...
 */
  var ExpandSubscriber = (function (_super) {
    ...
    ExpandSubscriber.dispatch = function (arg) {
      var subscriber = arg.subscriber; var result = arg.result; var value = arg.value; var index = arg.index
 ...
 */
  var FindValueSubscriber = (function (_super) {
    ...
    FindValueSubscriber.prototype._next = function (value) {
      var _a = this; var predicate = _a.predicate; var thisArg = _a.thisArg
      var index = this.index++
      try {
 ...
 */
  var GroupDurationSubscriber = (function (_super) {
    ...
    /** @deprecated internal use only */ GroupDurationSubscriber.prototype._unsubscribe = function () {
      var _a = this; var parent = _a.parent; var key = _a.key
 ...
 */
  var GroupedObservable = (function (_super) {
    ...
    /** @deprecated internal use only */ GroupedObservable.prototype._subscribe = function (subscriber) {
      var subscription = new Subscription()
      var _a = this; var refCountSubscription = _a.refCountSubscription; var groupSubject = _a.groupSubject
 ...
 */
  var AuditSubscriber = (function (_super) {
    ...
    AuditSubscriber.prototype.clearThrottle = function () {
      var _a = this; var value = _a.value; var hasValue = _a.hasValue; var throttled = _a.throttled
      if (throttled) {
 ...
 */
  var RepeatSubscriber = (function (_super) {
    ...
    RepeatSubscriber.prototype.complete = function () {
      if (!this.isStopped) {
        var _a = this; var source = _a.source; var count = _a.count
        if (count === 0) {
 ...
 */
  var RepeatWhenSubscriber = (function (_super) {
    ...
    /** @deprecated internal use only */ RepeatWhenSubscriber.prototype._unsubscribe = function () {
      var _a = this; var notifications = _a.notifications; var retriesSubscription = _a.retriesSubscription
      if (notifications) {
    ...
    /** @deprecated internal use only */ RepeatWhenSubscriber.prototype._unsubscribeAndRecycle = function () {
      var _a = this; var notifications = _a.notifications; var retries = _a.retries; var retriesSubscription = _a.retriesSubscription
      this.notifications = null
      this.retries = null
      this.retriesSubscription = null
 ...
 */
  var RetryWhenSubscriber = (function (_super) {
    ...
    /** @deprecated internal use only */ RetryWhenSubscriber.prototype._unsubscribe = function () {
      var _a = this; var errors = _a.errors; var retriesSubscription = _a.retriesSubscription
      if (errors) {
        errors.unsubscribe()
        this.errors = null
      }
    ...
    RetryWhenSubscriber.prototype.notifyNext = function (outerValue, innerValue, outerIndex, innerIndex, innerSub) {
      var _a = this; var errors = _a.errors; var retries = _a.retries; var retriesSubscription = _a.retriesSubscription
      this.errors = null
      this.retries = null
      this.retriesSubscription = null
      this._unsubscribeAndRecycle()
 ...
 */
  var SequenceEqualSubscriber = (function (_super) {
    ...
    SequenceEqualSubscriber.prototype.checkValues = function () {
      var _c = this; var _a = _c._a; var _b = _c._b; var comparor = _c.comparor
  ...
  var ImmediateDefinition = (function () {
    ...
    ImmediateDefinition.prototype.partiallyApplied = function (handler) {
      ...
      var fn = function result () {
        var _a = result; var handler = _a.handler; var args = _a.args
    ...
    ImmediateDefinition.prototype.createPostMessageSetImmediate = function () {
      ...
      var fn = function setImmediate () {
        var _a = setImmediate; var messagePrefix = _a.messagePrefix; var instance = _a.instance
        var handle = instance.addFromSetImmediateArguments(arguments)
    ...
    ImmediateDefinition.prototype.createMessageChannelSetImmediate = function () {
      ...
      var fn = function setImmediate () {
        var _a = setImmediate; var channel = _a.channel; var instance = _a.instance
        var handle = instance.addFromSetImmediateArguments(arguments)
 ...
 */
  var SubscribeOnObservable = (function (_super) {
    ...
    SubscribeOnObservable.dispatch = function (arg) {
      var source = arg.source; var subscriber = arg.subscriber
 ...
 */
  var ThrottleSubscriber = (function (_super) {
    ...
    /** @deprecated internal use only */ ThrottleSubscriber.prototype._unsubscribe = function () {
      var _a = this; var throttled = _a.throttled; var _trailingValue = _a._trailingValue; var _hasTrailingValue = _a._hasTrailingValue; var _trailing = _a._trailing
    ...
    ThrottleSubscriber.prototype._sendTrailing = function () {
      var _a = this; var destination = _a.destination; var throttled = _a.throttled; var _trailing = _a._trailing; var _trailingValue = _a._trailingValue; var _hasTrailingValue = _a._hasTrailingValue
 ...
 */
  ...
  function dispatchWindowTimeSpanOnly (state) {
    var subscriber = state.subscriber; var windowTimeSpan = state.windowTimeSpan; var window = state.window
    if (window) {
  ...
  function dispatchWindowCreation (state) {
    var windowTimeSpan = state.windowTimeSpan; var subscriber = state.subscriber; var scheduler = state.scheduler; var windowCreationInterval = state.windowCreationInterval
  ...
  function dispatchWindowClose (state) {
    var subscriber = state.subscriber; var window = state.window; var context = state.context
    ...
    ColdObservable.prototype.scheduleMessages = function (subscriber) {
      ...
      for (var i = 0; i < messagesLength; i++) {
        ...
        subscriber.add(this.scheduler.schedule(function (_a) {
          var message = _a.message; var subscriber = _a.subscriber
 ...
 */
  ...
  var VirtualTimeScheduler = (function (_super) {
    ...
    VirtualTimeScheduler.prototype.flush = function () {
      var _a = this; var actions = _a.actions; var maxFrames = _a.maxFrames
      var error, action
