...
Utf16Decoder.prototype.write = function (buf) {
  if (!this.decoder) {
    ...
    var encoding = detectEncoding(buf, this.options.defaultEncoding)
...
function detectEncoding (buf, defaultEncoding) {
  ...
  if (buf.length >= 2) {
    ...
    { enc = 'utf-16le' } else {
      ...
      var asciiCharsLE = 0; var asciiCharsBE = 0
      // Counts of chars in both positions

      var _len = Math.min(buf.length - (buf.length % 2), 64) // Len is always even.
