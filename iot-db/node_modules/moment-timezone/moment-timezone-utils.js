...
(function (root, factory) {
  ...
  function packBase60 (number, precision) {
    ...
    var fraction = packBase60Fraction(absolute - whole, Math.min(~~precision, 10))
  ...
  function findAndCreateLinks (input, output, links, groupLeaders) {
    var i; var j; var a; var b; var group; var foundGroup; var groups = []
  ...
  function filterYears (source, start, end) {
    ...
    var untils = slice.apply(source.untils, indices)
