...
(function () {
  ...
  function esqueryModule () {
    ...
    function sibling (node, selector, ancestry, side) {
      var parent = ancestry[0]; var listProp; var startIndex; var keys; var i; var l; var k; var lowerBound; var upperBound
    ...
    function adjacent (node, selector, ancestry, side) {
      var parent = ancestry[0]; var listProp; var keys; var i; var l; var idx
      if (!parent) { return false }
      keys = estraverse.VisitorKeys[parent.type]
      for (i = 0, l = keys.length; i < l; ++i) {
        listProp = parent[keys[i]]
    ...
    function match (ast, selector) {
      var ancestry = []; var results = []; var altSubjects; var i; var l; var k; var m
