...
function plugin (options, Parser) {
  return class extends Parser {
    ...
    jsx_readToken () {
      let out = ''; let chunkStart = this.pos
      for (;;) {
    ...
    jsx_readEntity () {
      let str = ''; let count = 0; let entity
    ...
    jsx_parseNamespacedName () {
      let startPos = this.start; let startLoc = this.startLoc
    ...
    parseExprAtom (refShortHandDefaultPos) {
      if (this.type === tok.jsxText) { return this.jsx_parseText(this.value) } else if (this.type === tok.jsxTagStart) { return this.jsx_parseElement() } else { return super.parseExprAtom(refShortHandDefaultPos) }
    }
