...
module.exports = {
  ...
  create (context) {
    ...
    const ignoreRegExpLiterals = options.ignoreRegExpLiterals || false

    const ignoreTrailingComments = options.ignoreTrailingComments || options.ignoreComments || false
    ...
    function checkProgramForMaxLength (node) {
      ...
      const comments = ignoreComments || maxCommentLength || ignoreTrailingComments ? sourceCode.getAllComments() : []
