...
module.exports = {
  ...
  create (context) {
    ...
    const MESSAGE_UNNECESSARY = "Unnecessarily quoted property '{{property}}' found."

    const MESSAGE_UNQUOTED = "Unquoted property '{{property}}' found."

    const MESSAGE_NUMERIC = "Unquoted number literal '{{property}}' used as key."

    const MESSAGE_RESERVED = "Unquoted reserved word '{{property}}' used as key."
